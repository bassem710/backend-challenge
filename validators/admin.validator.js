...
class AdminValidator {
  ...
  static validateVerifyAdminAccount = asyncHandler(async (req, res, next) => {
  ...
  // Validate verify user account fields
  static validateVerifyUserAccount = asyncHandler(async (req, res, next) => {
    const schema = Joi.object({
      code: Joi.string()
        .length(6)
        .pattern(/^[0-9]+$/)
